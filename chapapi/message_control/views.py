...
from .serializers import GenericFileUploadSerializer , GenericFileUpload , Message , MessageAttachment , MessageSerializer
...
class MessageView(ModelViewSet):
    ...
    def create(self, request, *args, **kwargs):
        ...
        if attachments:
            MessageAttachment.objects.bulk_create([MessageAttachment(**attachments , message_id=serializer.data["id"]) for attachment in attachments])
    ...
    def update(self, request, *args, **kwargs):
        ...
        if attachments:
            MessageAttachment.objects.bulk_create([MessageAttachment(**attachments , message_id=instance.id) for attachment in attachments])
